...
class KasaSistemi(ctk.CTk):
    def __init__(self):
        ...
        self.web_btn = ctk.CTkButton(btn_kutu, text="🌐 Web", font=("Arial", 16, "bold"), fg_color="#3949AB", hover_color="#303F9F", command=self.web_pos_ac, width=70, height=35)
        self.web_btn.pack(side="left", padx=3)
        self.muzik_btn = ctk.CTkButton(btn_kutu, text="🎵 Spotify", font=("Arial", 16, "bold"), fg_color="#1DB954", hover_color="#1AA34A", command=self.muzik_ayari_penceresi, width=70, height=35)
